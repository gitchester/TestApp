...
public class DecodeEditEncodeTest extends AndroidTestCase {
    ...
    private void videoEditTest() {
        ...
        if (DEBUG_SAVE_FILE) {
            ...
            String dirName = cacheDir.getAbsolutePath();
    ...
    public static class VideoChunks {
        ...
        public ArrayList<Long> getmTimes() {
            return mTimes;
        }

        public void setmTimes(ArrayList<Long> mTimes) {
            this.mTimes = mTimes;
        }

        private ArrayList<Long> mTimes = new ArrayList<Long>();

        public ArrayList<ByteBuffer> getmBuffers() {
            return mBuffers;
        }

        public void setmBuffers(ArrayList<ByteBuffer> mBuffers) {
